    ...
    <SharedPageNav>
      <div style={{ maxWidth: 860, margin: "0 auto", padding: "2rem 1rem 5rem" }}>
        ...
        <nav style={{ fontSize: "0.85rem", color: "#64748b", marginBottom: "1rem" }}>
          ...
          {" › "}
          <span style={{ color: "#ef4444" }}>Disclaimer</span>
        </nav>
        ...
        <div style={{ display: "grid", gap: "1rem", marginTop: "1.5rem" }}>
          {[
            ...
            ["Tiada hubungan rasmi", "Melainkan dinyatakan secara jelas, halaman ini tidak semestinya mewakili, dimiliki, atau dioperasikan oleh mana-mana jenama pihak ketiga yang disebut dalam artikel atau halaman rujukan."],
            ["Penggunaan atas risiko sendiri", "Dengan menggunakan halaman ini, anda memahami bahawa semua penggunaan kandungan, pautan, dan ciri yang tersedia adalah atas risiko dan pertimbangan anda sendiri."],
          ].map(([title, body]) => (
            <section
              key={title}
              style={{
