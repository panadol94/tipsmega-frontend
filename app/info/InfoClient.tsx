          ...
          <section className="space-y-4 mt-4">
            ...
            <div className="card p-6 bg-slate-900/80 border-white/5">
              ...
              <div className="space-y-4 text-[13px] text-white/60 leading-relaxed">
                ...
                <div>
                  ...
                  <p>Lihat bacaan indikatif yang dipaparkan dan fahami metodologi serta batasnya; ia bukan jaminan keputusan pusingan seterusnya.</p>
                </div>
              </div>
            </div>
            ...
            <div className="card p-6 bg-slate-900/80 border-amber-400/20">
              ...
              <div className="text-[13px] leading-relaxed text-white/60 space-y-3">
                ...
                <p>
                  Tarikh semakan metodologi terakhir: 24 September 2026. Perubahan besar pada cara pengiraan akan diterangkan pada halaman ini.
                </p>
              </div>
            </div>
