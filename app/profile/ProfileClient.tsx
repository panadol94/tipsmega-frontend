            ...
            <div className="app-shell pb-20">
                ...
                <header className="card relative overflow-hidden p-6 min-h-[220px] flex flex-col justify-between bg-[#0c1224] border-white/15">
                    ...
                    <div className="relative z-10">
                        <div className="flex items-center gap-2 mb-2">
                            <div className="h-1.5 w-8 bg-red-500 rounded-full shadow-[0_0_10px_rgba(16,185,129,0.5)]" />
                            <span className="text-[10px] font-black tracking-[0.3em] text-red-400/90 uppercase">Identity Card</span>
                        </div>
                        ...
                        <div className="font-mono text-[10px] text-white/40 flex flex-col gap-1 mt-1">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="truncate max-w-[160px] text-red-400 font-black tracking-widest text-xs uppercase">{username || "UNKNOWN_UNIT"}</span>
                            </div>
                            <div className="flex items-center gap-2">
                                <span className="opacity-40 select-none min-w-[36px]">D-ID:</span>
                                <span className="truncate max-w-[160px] text-red-500/60 font-bold tracking-tight">{deviceId || "UNREGISTERED"}</span>
                            </div>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-2 gap-4 mt-4">
                    ...
                    >
                        ...
                        <div className={`w-9 h-4.5 rounded-full p-0.5 flex items-center transition-all duration-300 ${soundEnabled ? 'bg-red-500/20 border border-red-500/30' : 'bg-white/5 border border-white/10'}`}>
                            <div className={`w-3 h-3 rounded-full shadow-lg transition-all duration-300 transform ${soundEnabled ? 'translate-x-[18px] bg-red-400 shadow-[0_0_8px_rgba(52,211,153,0.8)]' : 'translate-x-0 bg-white/20'}`} />
                        </div>
                    </button>
                    <button
                    ...
                    >
                        ...
                        <div className={`w-9 h-4.5 rounded-full p-0.5 flex items-center transition-all duration-300 ${hapticEnabled ? 'bg-red-500/20 border border-red-500/30' : 'bg-white/5 border border-white/10'}`}>
                            <div className={`w-3 h-3 rounded-full shadow-lg transition-all duration-300 transform ${hapticEnabled ? 'translate-x-[18px] bg-red-400 shadow-[0_0_8px_rgba(52,211,153,0.8)]' : 'translate-x-0 bg-white/20'}`} />
                        </div>
                    </button>
                </div>
                ...
                <div className="flex flex-col gap-4 mt-4">
                    ...
                    <a
                        ...
                        className="card relative overflow-hidden p-5 active:scale-[0.98] transition-all bg-[#0a1a0f] border-red-500/20 hover:border-red-400/40 group"
                    >
                        {/* Green glow background */}
                        <div className="absolute -top-8 -right-8 w-32 h-32 bg-red-500/10 rounded-full blur-3xl pointer-events-none group-hover:bg-red-500/20 transition-all duration-500" />
                        <div className="absolute -bottom-6 -left-6 w-24 h-24 bg-green-500/5 rounded-full blur-2xl pointer-events-none" />

                        <div className="relative z-10 flex items-center gap-4">
                            {/* WhatsApp Icon */}
                            <div className="w-12 h-12 rounded-2xl bg-red-500/15 border border-red-500/25 flex items-center justify-center shadow-[0_0_15px_rgba(16,185,129,0.15)] group-hover:shadow-[0_0_25px_rgba(16,185,129,0.3)] transition-all">
                                <svg viewBox="0 0 24 24" className="w-6 h-6 fill-red-400 group-hover:fill-red-300 transition-colors">
                            ...
                            <div className="flex-1">
                                <div className="flex items-center gap-2 mb-1">
                                    <span className="text-[11px] font-black tracking-[0.2em] text-red-400 uppercase">Join Komuniti</span>
                                    <div className="w-1.5 h-1.5 rounded-full bg-red-400 animate-pulse shadow-[0_0_6px_rgba(52,211,153,0.8)]" />
                                </div>
                                <p className="text-[10px] text-white/40 tracking-wide">Komuniti VIP • Tips Harian • Alert Terkini</p>
                            </div>

                            {/* Arrow */}
                            <div className="text-red-500/40 group-hover:text-red-400 group-hover:translate-x-1 transition-all duration-300">
                ...
                <section className="card p-6 bg-slate-900/90 border-white/10 mt-4">
                    <div className="flex items-center justify-between mb-6 pb-4 border-b border-white/5">
                        <div className="flex items-center gap-3">
                            <div className="h-2 w-2 bg-red-500 rounded-full shadow-[0_0_8px_rgba(16,185,129,0.5)] animate-pulse" />
                            <span className="text-xs font-black italic tracking-[0.2em] text-white">ACTIVITY LOGS</span>
                        </div>
                        <span className="text-[9px] font-mono text-red-500/40">LIVE_SYNC: OK</span>
                    </div>
                    ...
                    <div className="space-y-4">
                        {mockHistory.map((h, idx) => (
                            <div key={idx} className="flex items-center justify-between p-4 rounded-xl bg-white/[0.03] border border-white/5 hover:bg-white/[0.06] transition-all">
                                <div>
                                    <div className="font-mono text-xs font-bold text-red-400">{h.id}</div>
